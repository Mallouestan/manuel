# Le manuel du chercheur Mallouestanais
...
> Ce manuel définit le contexte commun auquel tout le monde choisi d'adhérer en venant sur le lieu

### Annexes

- [PE: Plan des espaces](pe.md)
- [Le manuel du visiteur Mallouestanais](visiteur.md)
- [Le guide de l'echange](echanges.md)
...
Certaines décisions peuvent impacter le contexte commun et les membres du lieu, ils nécessite donc un consensus de tous les membres du projet. Un temps est accordé aux membres pour qu'iels ai tous l'opportunité de s'exprimé. Ces delais différent en fonction de l'impact que la décision peut encourir sur les membres. Il est donc définit comme suit:

| Type de décision | Description | Délai accordé |
|:----------------| ----------- | -------------: |
| Acte irréversible | Tout acte impactant le contexte commun qui n'est pas réversible en 5 jours | 5 jours |
| Manuel et annexes | Toute décision concernant ce manuel et ses annexes | 14 jours |

> Une liste des membres souhaitant être contacter en cas de décision est présent sur le lieu indiquant la manière dont il souhaite être contacter.

### Décision de responsabilités

Certaines décision malgré le fait qu'elle impacte le commun serait potentiellement liberticide si elle dépendait systématiquement d'une unanimité. Ces décisions permette de définir qui adhère ou non a une intention mais en aucun cas ne permettent d'empecher ou d'imposer une issue. 

### Toute décision

Toute décision peut être contester par un véto. Le véto peux par nature être opressive et doit être justifier par l'incompatibilité de la décision avec ce manuel seul representant de nos engagement mutuels. 

Un véto est uniquement contester si plus  de 60% des membres confirme une une mauvaise interpretation de ce manuel. Si une erreur ou abération est présente dans le manuel il ne peut être emputé a l'individu.
...
Nous somme conscient que chacun est déconstruit à des niveaux variables et que chacun évolue à sa vitesse. Malgré cela, un minimum de déconstruction est nécessaire pour garantir l'avancé de l'enssemble. Nous demandons donc sur le lieu:
...
Nous somme conscient que nous sommes des êtres de nature imparfaite. Nous faisons donc tous des erreurs ou des écarts à nos valeurs et idéaux. Nous nous devons d'être indulgent, tout d'abords envers nous-même et envers autrui. Mais, nous acceptons également que tout écart qui impacte le lieu et ses membres à long therme doit être traité.

Lors d'un conflit:

1. Nous essayons de le résoudre entre les parties directement.
2. Si le conflit n'arrive pas à être gérer entre les parties, une partie neutre est inséré dans la gestion de conflit pour tempérer.
3. Si, malgré ces étapes un membre se sent oppressé par le conflit, un ultimatum peut être définit accordant une chance à l'oppresseur perçu. Cet ultimatum devra être justifié par le non-respect de ce manuel au même titre que le véto.

> L'ultimatum est donné avec des conditions et les conséquences lié au non respect de l'ultimatum. Ces critères ainsi que les conditions sont décidé entre tout les membres du collectif.
...
Les divers dons sont ajoutés au pot commun et un budget mensuel animaux est soustrait du pot commun. 

### Résidents
Tout résident en acceptons de venir sur le lieux accepte que les dépenses lié au lieux n'ont aucune garantit d`être restitué. Le terrain et l'immobilier relève de sa responsabilité, ainsi les autres résidents ne peuvent garantir l'achat ou la vente du bien.
...
Nous somme conscient que l'espace sur lequel évolue le projet est limité par le système ainsi que géographiquement. Ces espaces relève du contexte commun auquel chacun adhère en devenant membre. Le PE (Plan des Espaces) a pour but de définir de façon transparente la vision commune de ces espaces.
...
- Un nombre maximums de 16 visiteurs  a la fois est fixés pour passer une nuit sur le lieux 
...
> En absence de nouvelles de la part des résidents associé l'espace privée reste privée pendant quatre mois

### Les espaces reservés

Un espace reservé est obtenue suite a une demande concernant un espace libre. Cette "réservation" ne releve exeptionnellement pas de la même gouvernance que le manuel mais de la gouvernance d'une décision de responsabilités.
